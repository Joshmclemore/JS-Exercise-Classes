...
const jeff = new Person('Jeff', 65);

console.log('task 1', jeff)
jeff.eat('grapes');
jeff.eat('salad');
console.log(jeff)
jeff.poop();
...
const bob = new Lambdasian({
  name: 'Bob',
  age: 50,
  location: 'Delaware',
})

console.log('task 3', bob);
...
console.log('task 4', bill.demo('objects'));
...
const betty = new Student({
  ...
  className: 'Web50',
  favSubjects: ['Classes', 'Prototypes', 'Objects']
})

console.log('task 4', bill.grade(betty, 'objects'));
console.log('task 5a', betty.listSubjects());
console.log('task 5b', betty.PRAssignment('objects'));
console.log('task 5c', betty.sprintChallenge('Arrays'));
